...
RUN apt-get update && apt-get -y --no-install-recommends install curl ca-certificates software-properties-common && \
...
#RUN groupadd jenkins -g JENKINSGID && useradd -u JENKINSUID -g JENKINSGID -m jenkins
